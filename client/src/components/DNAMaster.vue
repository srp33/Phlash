...
<div class="container">
   ...
   <div class="alert alert-primary">
      ...
      <p>
         ...
         like to modify any information <em>before beginning the annotation process</em>, please
   ...
   <div id="dnamaster">
      <button class="btn btn-dark btn-sm" id="add-btn" align="center" v-b-modal.add-modal><strong>Add a new CDS</strong></button>
               ...
               <tr v-for="(curr, index) in dnamaster" :key="index">
                  ...
                  <td>
                     <div class="btn-group" role="group">
                        <button class="btn btn-dark btn-sm" id="update-btn" v-b-modal.update-modal @click="editCDS(curr)"><strong>Update</strong></button>
                        <button class="btn btn-dark btn-sm" id="delete-btn" v-b-modal.delete-modal @click="deleteCDS(curr)"><strong>Delete</strong></button>
                     </div>
                  </td>
               </tr>
            </tbody>
