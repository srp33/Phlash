<template>
   <div class="container">
      ...
      <div class="alert alert-primary">
         ...
         <p>
            Below is the data from your DNA Master GenBank file. If you would
            like to modify any information, please
         ...
         <router-link to="/api/upload_genemark">
            <button class="btn btn-primary"><strong>Next</strong></button>
         </router-link>
      </div>
      ...
      <div id="dnamaster">
         <button class="btn btn-info btn-sm" id="add-btn" align="center" v-b-modal.add-modal><strong>Add a new CDS</strong></button>
                  ...
                  <tr v-for="(curr, index) in dnamaster" :key="index">
                     ...
                     <td>
                        <div class="btn-group" role="group">
                           <button class="btn btn-warning btn-sm" id="update-btn" v-b-modal.update-modal @click="editCDS(curr)"><strong>Update</strong></button>
                           <button class="btn btn-danger btn-sm" id="delete-btn" v-b-modal.delete-modal @click="deleteCDS(curr)"><strong>Delete</strong></button>
                        </div>
                     </td>
                  </tr>
               </tbody>
      ...
      <b-modal ref="addCDSModal" id="add-modal" title="Add a new CDS" hide-footer>
         <b-form @submit="onSubmitAdd" @reset="onResetAdd" align="left">
            <b-form-group label="ID:" label-for="add-id-input">
               <b-form-input id="add-id-input" type="text" v-model="newCDS.id" required placeholder="Enter ID"></b-form-input>
            </b-form-group>
            <b-form-group label="Start:" label-for="add-start-input">
               <b-form-input id="add-start-input" type="number" v-model="newCDS.start" required placeholder="Enter start"></b-form-input>
            </b-form-group>
            <b-form-group label="Stop:" label-for="add-stop-input">
               <b-form-input id="add-stop-input" type="number" v-model="newCDS.stop" required placeholder="Enter stop"></b-form-input>
            </b-form-group>
            <b-form-group label="Strand:">
               <b-dropdown class="strand-dropdown" text="Select strand" variant="outline-dark">
                  <b-dropdown-item>+ (Forward)</b-dropdown-item>
                  <b-dropdown-item>- (Reverse)</b-dropdown-item>
               </b-dropdown>
            </b-form-group>
      ...
      <b-modal ref="updateCDSModal" id="update-modal" title="Update CDS" hide-footer>
         <b-form @submit="onSubmitUpdate" @reset="onResetUpdate" align="left">
            <b-form-group label="Start:" label-for="update-start-input">
               <b-form-input id="update-start-input" type="number" v-model="updatedCDS.start" required placeholder="Enter start position"></b-form-input>
            </b-form-group>
            <b-form-group label="Stop:" label-for="update-stop-input">
               <b-form-input id="update-stop-input" type="number" v-model="updatedCDS.stop" required placeholder="Enter stop position"></b-form-input>
            </b-form-group>
            <b-form-group label="Strand:">
               <b-dropdown class="strand-dropdown" text="Select strand" variant="outline-dark">
                  <b-dropdown-item>+ (Forward)</b-dropdown-item>
