...
export default {
  ...
  methods: {
    getData(cdsID) {
      axios.get(`http://localhost:5000/api/annotations/more/${this.$route.params.phageID}/${cdsID}`)
        .then(response => {
    ...
    updateCDS(payload, cdsID) {
      axios.put(`http://localhost:5000/api/annotations/more/${this.$route.params.phageID}/${cdsID}`,
          payload
        )
        .then(() => {
    ...
    deleteCDS(cdsID) {
      axios.delete(`http://localhost:5000/api/annotations/more/${this.$route.params.phageID}/${cdsID}`)
        .then(() => {
          this.$router.push(`/annotations/${this.$route.params.phageID}`);
        })
        .catch(error => {
